...
<div class="row member-row">
  ...
  <div class="col-md-9">
    ...
    <p>
    Yuhao Liu received his Bachelor's degree in Data Science and Big Data Technology from Nanjing University of Information Science & Technology and University of Reading in 2026. He is currently pursuing an MPhil degree in Artificial Intelligence at The Chinese University of Hong Kong, Shenzhen. His research interests primarily focus on multi-modal large language models, vision-language models, and vision-language-action models.
    </p>
  </div>
</div>
...
<div class="row member-row">
  <div class="col-md-3">
    <img src="{{ '/assets/images/photo/QinChuan.jpeg' | relative_url }}" alt="Qin Chuan's photo" class="member-photo">
  </div>
  <div class="col-md-9">
    <h3>秦川 &nbsp; Qin Chuan</h3>
    <p><i class="fa fa-clock-o"></i> 2026.08 ~ Now</p>
    <!-- <p><i class="fa fa-envelope-o"></i> <a href="mailto:hongrongwang@link.cuhk.edu.cn">hongrongwang@link.cuhk.edu.cn</a></p> -->
    <p>
    Qin Chuan received his undergraduate degree in Robotics Engineering from South China University of Technology in 2026. His primary research interests include machine learning and embodied intelligence.
    </p>
  </div>
</div>
...
<div class="row member-row">
  <div class="col-md-3">
    <img src="{{ '/assets/images/photo/LucongLiao.png' | relative_url }}" alt="Lucong Liao's photo" class="member-photo">
  </div>
  <div class="col-md-9">
    <h3>廖禄聪 &nbsp; Lucong Liao</h3>
    <p><i class="fa fa-clock-o"></i> 2026.08 ~ Now</p>
    <!-- <p><i class="fa fa-envelope-o"></i> <a href="mailto:hongrongwang@link.cuhk.edu.cn">hongrongwang@link.cuhk.edu.cn</a></p> -->
    <p>
